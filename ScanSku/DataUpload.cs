...
namespace ScanSKU
{
    class DataUpload
    {
        ...
        void Upload()
        {
            ...
            {
                Android.Util.Log.Info("SubmitCollectionData", ex.Message);
            }

            if (status == false)
            {
                Toast.MakeText(mContext, "There was a problem with the upload", ToastLength.Long).Show();
                // Instantiate the builder and set notification elements:
                Notification.Builder builder = null;
                try
                {
                    builder = new Notification.Builder(mContext, "NOTI_CH_ID");
                }
                catch
                {
            ...
            {
                Toast.MakeText(mContext, "Upload complete", ToastLength.Long).Show();
            }
